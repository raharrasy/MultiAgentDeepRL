...
class State(object) :
		def __init__(self, sight_radius, num_players, max_food_num, arena_size, food_rate = 15, num_game_frames = 40000):
		...
		def reset(self, food_rate = 15, num_game_frames = 40000):
		...
		def checkpointing(self):
			...
			suffix = "../tmp/checkpoint/Apple/DRUQL/Player"
			prefix = ".ckpt"
			for player in self.player_list:
